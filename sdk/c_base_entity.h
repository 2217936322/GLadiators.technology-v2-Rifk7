...
public:
	...
	netvar(get_flags(), int32_t, "CBaseEntity", "m_fFlags")
	...
	netvar(clientside_anim(), float, "CBaseEntity", "m_bClientSideAnimation")
	...
	datamap(get_velocity(), c_vector3d, "m_vecVelocity")
