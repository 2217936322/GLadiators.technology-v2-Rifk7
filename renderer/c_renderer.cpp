...
#include "../fonts/visitor_tt2_brk.h"
...
c_renderer::c_renderer(IDirect3DDevice9* dev)
{
	DWORD fnt;
	AddFontMemResourceEx(reinterpret_cast<void*>(profont), sizeof(profont), nullptr, &fnt);
	AddFontMemResourceEx(reinterpret_cast<void*>(visitor_tt2_brk), sizeof(visitor_tt2_brk), nullptr, &fnt);

	fonts[fnv1a("pro12")] = c_font(_("ProFont for Powerline"), 12, FW_REGULAR);
	fonts[fnv1a("pro13")] = c_font(_("ProFont for Powerline"), 13, FW_REGULAR);
	fonts[fnv1a("pro17")] = c_font(_("ProFont for Powerline"), 17, FW_REGULAR);

	fonts[fnv1a("visitor_ttESP")] = c_font(_("Visitor TT2 BRK"), 9, FW_REGULAR);
	fonts[fnv1a("visitor_tt12")] = c_font(_("Visitor TT2 BRK"), 9, FW_REGULAR);
	fonts[fnv1a("visitor_tt13")] = c_font(_("Visitor TT2 BRK"), 10, FW_REGULAR);
	fonts[fnv1a("visitor_tt17")] = c_font(_("Visitor TT2 BRK"), 13, FW_REGULAR);
	init_device_objects(dev);
}
