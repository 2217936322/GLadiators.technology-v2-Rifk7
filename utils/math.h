...
public:
	...
	void VectorAngles(const c_vector3d& vecForward, c_vector3d& vecAngles);
	void VectorAngles(const c_vector3d& forward, c_vector3d& up, c_vector3d& angles);
	void VectorTransform(const c_vector3d in1, const matrix3x4 in2, c_vector3d& out);
	c_vector3d CalcAngle(const c_vector3d& vecSource, const c_vector3d& vecDestination);
	vec_t VectorNormalize(c_vector3d& v);
	void AngleVectors(const c_vector3d& angles, c_vector3d* forward);
	void NormalizeAngles(c_vector3d& angles);
	float NormalizeYaw(float yaw);
	void AngleVectors(const c_vector3d& angles, c_vector3d* forward, c_vector3d* right, c_vector3d* up);
	void RandomSeed(int seed);
	float RandomFloat(float min, float max);
	int Random(int min, int max);
	bool Clamp(c_vector3d& angles);
	void ClampAngles(c_vector3d& angles);
	float GRD_TO_BOG(float GRD);
	float Distance(c_vector2d point1, c_vector2d point2);
	c_vector3d ProjectPoint(c_vector3d Origin, double Yaw, double Distance);
