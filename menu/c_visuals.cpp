...
//		make_child(c_checkbox, __("Weapon"), config.esp.enemy.weapon),
//		make_child(c_color_select, __("Weapon Color"), config.esp.enemy.weapon_color)
	}));
...
//		make_child(c_checkbox, __("Local Impacts"), config.esp.team.impacts),
		make_child(c_select, __("Impacts"), std::vector<std::pair<std::string, char>> {
			__("Off"),
			__("Laser"),
			__("Animated")
		}, config.esp.team.impacts),
	  	make_child(c_color_select, __("Impacts Color"), config.esp.team.impacts_color),
//		make_child(c_checkbox, __("Enemy Impacts"), config.esp.enemy.impacts),
		make_child(c_select, __("Enemy Impacts"), std::vector<std::pair<std::string, char>> {
			__("Off"),
			__("On")
		}, config.esp.enemy.impacts),
